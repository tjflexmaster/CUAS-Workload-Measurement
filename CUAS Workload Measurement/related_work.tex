...
Multiple resource theory plays a key role in how we are measuring workload.
\cite{wickens2002multiple} The multiple resource model defines four categorical dimensions that
...
control, otherwise known as “fan-out”. \cite{cummings2007predicting}  This work used queuing theory
