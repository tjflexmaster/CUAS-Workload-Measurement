...
\section{Actor Models} {\sc Copy from SMC paper, referencing that paper and telling the reader we copied it from there.  Need to explain what the math means, identifying that we are using FSMs and talking about how we denote the different elements of the FSM and what they mean in the Java model.}
\input{framework.tex}
